<%@ Page Title="" Language="C#" MasterPageFile="~/KriStocks.Master" AutoEventWireup="true" CodeBehind="CurrencySymbols.aspx.cs" Inherits="TestSite4213.WebForm5" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container marketing">
        <div class="span11">
            <h2 class="featurette-heading">Kristocks  <span class="muted">Currency Symbol list</span></h2>
            <br />
            <p class="lead">Here you can find all the currency symbols that can be converted on our <a href="SharePrices.aspx">currency convertor </a>page.</p>
